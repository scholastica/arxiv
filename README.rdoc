...
A Ruby wrapper for the {arXiv API}[http://arxiv.org/help/api/index]. {arXiv}[[http://arxiv.org/] is an open access pre-print server used primarily in physics, mathematics, computer science, quantitative biology, quantitative finance and statistics.
...
And inspect it:
  ...
  manuscript.abstract     # => "Precise astronomical spectroscopic analyses routinely assume that individual..."
...
This is very far from a complete wrapper around the arXiv API. We'll be making improvements as needed for our overlay journals. If you'd like something added, send us a note or make a pull request.
